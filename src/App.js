...
function App() {
  return (
    <ThemeProvider theme={theme}>
      <Router>
        <Box  sx={{background: {xs:"white",md:"#e3f2fd"}, display:"flex",alignItems:"center" ,position:'absolute',top:'0px',right:'0px',bottom:'0px',left:'0px'}}>
          <Grid maxWidth={"xl"} container sx={{justifyContent:"space-evenly" ,alignItems:"stretch",height:{xs:"100%",md:"80%"},alignContent:"center"}}>
