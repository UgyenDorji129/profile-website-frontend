...
function App() {
  return (
    <ThemeProvider theme={theme}>
      <Router>
        <Box maxWidth={"xl"} sx={{background: {xs:"white",md:"#e3f2fd"}, height: "-webkit-fill-available", height:"100vh",display:"flex", alignItems:{xs:"center", md:"center"}, overflow:"hidden"}}>
