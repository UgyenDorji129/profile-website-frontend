...
function App() {
  return (
    <ThemeProvider theme={theme}>
      <Router>
        <Box maxWidth={"xl"} sx={{background: {xs:"white",md:"#e3f2fd"},  position:'absolute',top:'0px',right:'0px',bottom:'0px',
          left:'0px',overflow:"hidden",}}>
          <Grid container sx={{justifyContent:"space-evenly", alignItems:"stretch",height:"100%", alignContent:"center"}}>
            <Grid item container xs ={11} md={10}  sx={{borderRadius:"24px",bgcolor:{md:theme.palette.primary.main,xs:"white", display:{sx:"flex", md:"block"}, justifyContent:"center"}}} >
